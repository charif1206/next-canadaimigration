...
import { usePostById } from '@/lib/hooks/useBlogs';
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 font-semibold">Loading post...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 w-full">
            ...
            <div className="flex flex-wrap items-center gap-6 text-white/90">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm md:text-base">{formatDate(post.createdAt)}</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm md:text-base font-semibold">{post.likesCount} Likes</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <article className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3 text-gray-600">
              ...
              <span className="text-sm">Last updated: {formatDate(post.updatedAt)}</span>
            </div>
